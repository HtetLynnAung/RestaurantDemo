...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>Touch - Restaurant Home</title>
                      ...
                      <div class="row">
                        <div class="col-3 align-self-center">
                          ...
                          <div class="ratio ratio-1x1">
                            <img class="object-fit-cover" src="<?php echo "https://storage.googleapis.com/restaurantdemo-bc376.appspot.com/".$result->data()['photo']; ?>" alt="Image">
                          </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <?php 
              ...
              $results = $fs->data_get_latest_documents();
              //print_r($results);
              foreach ($results as $result) {
                  if ($result->exists()) {
            ...
            ?>
              <div class="w-100 px-2" style="max-width: 320px">
                ...
                <div class="card border-0">
                  <!-- Image -->
                  <img class="object-fit" src="<?php echo "https://storage.googleapis.com/restaurantdemo-bc376.appspot.com/".$result->data()['photo']; ?>" alt="Image"/>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-auto">
                        <span class="fs-4 text-black">$ <?php echo $result->data()['price'] ?></span>
                      </div>
                    </div>
