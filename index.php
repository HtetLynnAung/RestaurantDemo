            ...
            <form class="block-decoration-2" id="contactForm">
               ...
               <!-- Contact number (hidden) -->
                  ...
                  <div class="mb-6">
                    ...
                    <input class="form-control" id="user_email" name="user_email" type="text" placeholder="Email Address" required>
                  </div>

                  <!-- Phone number -->
                  <div class="mb-6">
                    <label class="visually-hidden" for="user_pass">Passowrd</label>
                    <input class="form-control" id="user_pass" name="user_pass" type="tel" placeholder="Passowrd" required>
                  </div>
